// app/components/.../thread.tsx  (paste over your existing file)
import {
  ArrowDownIcon,
  ArrowUpIcon,
  CheckIcon,
      ...
      <MotionConfig reducedMotion="user">
        ...
        >
          <ThreadPrimitive.Viewport className="aui-thread-viewport relative flex flex-1 flex-col overflow-x-auto overflow-y-scroll px-4">
            ...
            {/* Composer removed — FinanceChat is embedded on app/assistant.tsx */}
...
/* ---------- rest of file unchanged (helper components) ---------- */
